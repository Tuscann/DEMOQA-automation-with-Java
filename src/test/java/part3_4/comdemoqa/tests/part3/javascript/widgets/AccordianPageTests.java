...
public class AccordianPageTests extends BaseTest {
    ...
    public void SelectFirstHeading() {
        ...
        Assert.assertEquals(actualText, expectedText, "Wrong first paragh");
    }
    ...
    public void SelectSecondHeading() {
        ...
        Assert.assertEquals(actualText, expectedText, "Wrong second paragh");
    }
    ...
    public void SelectThirdHeading() {
        ...
        Assert.assertEquals(actualText, expectedText, "Wrong third paragh");
    }
}