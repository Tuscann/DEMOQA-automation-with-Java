...
public class ProgressBarPageTests extends BaseTest {
    ...
    private static final String EXPECTED_GREY_COLOR = "rgba(233, 236, 239, 1)";
    ...
    public void verifyAllTextOnPage() {
        ...
        softAssert.assertEquals(progressBarPage.getStartStopButtonBackgroundColor(), EXPECTED_BACKGROUND_COLOR, WRONG_COLOR_VALUE_ERROR);
        softAssert.assertEquals(progressBarPage.getStartStopButtonBorderColor(), EXPECTED_BORDER_COLOR, WRONG_COLOR_VALUE_ERROR);
    ...
    public void clickStartButtonAndCheckProgressBarEndValue() {
        // Arrange & Act
        String actualProgressBarTopColorBefore = progressBarPage.getColorProgressTopBar();
        String actualProgressBarColorBefore = progressBarPage.getColorProgressBar();
        String actualStartButtonBackgroundColor = progressBarPage.getStartStopButtonBackgroundColor();
        ...
        String actualProgressBarAfter = progressBarPage.getColorProgressBar();
        String resetButtonText = progressBarPage.getResetButtonText();

        softAssert.assertEquals(actualProgressBarTopColorBefore, EXPECTED_GREY_COLOR, WRONG_COLOR_VALUE_ERROR);
        softAssert.assertEquals(actualProgressBarColorBefore, EXPECTED_START_COLOR, WRONG_COLOR_VALUE_ERROR);
        softAssert.assertEquals(actualStartButtonBackgroundColor, EXPECTED_BACKGROUND_COLOR, WRONG_COLOR_VALUE_ERROR);
        ...
        softAssert.assertEquals(actualProgressBarAfter, EXPECTED_GREEN_COLOR, WRONG_COLOR_VALUE_ERROR);
    ...
    @Test(enabled = true, description = "Click reset button and verify start button text")
    ...
    public void clickStartClickStopClickStartAndCheckProgressBarEndValue() {
        ...
        String actualProgressBarTopColorBefore = progressBarPage.getColorProgressTopBar();
        progressBarPage.clickStartButton();
        progressBarPage.clickStopButtonOnValue(STOP_VALUE_31);
        String actualProgressBarBetween = progressBarPage.getColorProgressBar();
        ...
        // Assert
        softAssert.assertEquals(actualProgressBarTopColorBefore, EXPECTED_GREY_COLOR, WRONG_COLOR_VALUE_ERROR);
        softAssert.assertEquals(actualProgressBarBetween, EXPECTED_START_COLOR, NOT_100_PERCENT_ERROR);
